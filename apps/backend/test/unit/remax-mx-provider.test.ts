...
function fixture() {
  const images = Array.from(
    { length: 9 },
    (_, index) =>
      `<img src="https://cdn.remax.com.mx/properties/682749/${(index + 1).toString(16).padStart(32, '0')}.jpeg">`
  ).join('');
...
test("enriches RE/MAX's empty server HTML from its structured listing endpoint", async () => {
        ...
        data: {
          data: {
            propiedad: {
              ...
              clave: 'RDV682749-451',
              operacion: '1',
              titulo: 'DEPARTAMENTO NUEVO EN VENTA EN COLONIA DEL VALLE NORTE',
              descripcion: '<p>Departamento de 115m2.</p>',
              tipo_nombre: 'Departamento',
              moneda: 'MXN',
              mxn_corriente: '6750000.00',
              calle: 'Xola',
              numero_exterior: '30',
              numero_interior: null,
              colonia_nombre: 'Del Valle Norte',
              ciudad_nombre: 'Ciudad de México',
              estado_nombre: 'Ciudad de México',
              postal: '03103',
              latitud: '19.3967',
              longitud: '-99.1682',
              m2_terreno: '115.00',
              m2_construccion: '115.00',
              cuartos: '3',
              banos: '2',
              ...
              niveles: '1',
              nivel_encuentra: '3',
              mantenimiento: '2500.00',
              moneda_mantenimiento: 'MXN',
              imagenes: imagePaths
            },
            agente: {
              nombre: 'Mario Enrique',
              apellido: 'Preciado Mendoza',
              imagen: '1770235711.jpg',
              celular: '5531054496'
            },
            oficina: {
              oficina_id: '451',
              oficina_nombre: 'RE/MAX Pro',
              oficina_telefono: '5589527336',
              oficina_callpicker: ''
            },
            datos: {
  ...
  assert.equal(
    ...
    'Xola 30, Del Valle Norte, Ciudad de México, Ciudad de México, 03103'
  );
