    ...
    props: {
      pageProps: {
        property: {
          ...
          attributes: {
            yearBuild: -1, condition: "Excelente", suites: 2, bathrooms: 2, parkings: 1,
            roofedSurface: 80, totalSurface: 103,
          },
          pictures,
          services: [
          ...
          agent: {
            firstName: "Almudena", lastName: "García Amieva", phone: "525524787333",
            email: "a.garcia.amieva@pulppo.com",
            profilePicture: "https://images.pulppo.com/property/contact/68b9efa2da7dd6e7f2ce13f3/profile_picture/Pulpoo-3.jpg",
          },
...
test("extracts Pulppo's structured listing and exact ordered gallery", () => {
  ...
  assert.equal(result.input.images[4]?.url, "https://images.pulppo.com/property/6a7347a912e1a0cada49dae6/picture_00000000000000000000000000000005.jpg");
  ...
  assert.equal(result.input.contact.agentAvatarUrl, "https://images.pulppo.com/property/contact/68b9efa2da7dd6e7f2ce13f3/profile_picture/Pulpoo-3.jpg");
